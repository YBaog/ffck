						...
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-table red"></i><span class="break"></span>新生攻略列表</h6>
									<div class="panel-actions">
										<a href="<?php echo U('Home/studentAdd');?>" ><button class="bk-margin-5 btn label-warning">添加新生攻略</button></a>
									</div>
								</div>
