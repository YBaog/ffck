				...
				<div class="col-lg-12">
					<div class="panel">
						<div class="panel-heading bk-bg-primary">
							<h6><i class="fa fa-table red"></i><span class="break"></span>接机列表</h6>
							<div class="panel-actions">
								<a href="<?php echo U('Home/planeAdd');?>" ><button class="bk-margin-5 btn label-warning">添加接机</button></a>
							</div>
						</div>
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered bootstrap-datatable datatable">
									...
									<tr>
										...
										<td>
											<a class="btn btn-info" href="<?php echo U('home/planeInfo');?>">
