						...
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-table red"></i><span class="break"></span>师兄分享列表</h6>
									<div class="panel-actions">
										<a href="<?php echo U('Home/brotherAdd');?>" ><button class="bk-margin-5 btn label-warning">添加师兄分享</button></a>
									</div>
								</div>
										...
										<table class="table table-striped table-bordered bootstrap-datatable datatable">
											...
											<tbody>
												<tr>
													...
													<td>
														<a class="btn btn-info" href="<?php echo U('home/raiderInfo');?>">
